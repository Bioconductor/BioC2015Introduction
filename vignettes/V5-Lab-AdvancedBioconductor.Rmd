---
title: "5. Advanced Lab for R & Bioconductor "
author: "Sonali Arora"
output:
...
*SummarizedExperiment* object. For a *SummarizedExperiment* 
...
- [Airway Vignette](http://bioconductor.org/packages/devel/data/experiment/vignettes/airway/inst/doc/airway.html)   
...
- Lab at BioC2015 by Mike Love. Differential expression, manipulation, and visualization of RNA-seq reads. (Session 1, Tuesday,  1:00pm -2:45pm)
- Lab at Bioc2015 by Thomas Girke. Automated NGS workflows with systemPipeR running on clusters or single machines, with a focus on VAR-seq.(Session 4, Tuesday,  3:15pm - 5:00pm)
